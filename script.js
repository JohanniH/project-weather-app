...
//Variables API-fethcing:
const apiKey = "4d3c9bb1319fa46fffbe53d11698b946";
let city = "Stockholm";
...
const todaysWeatherFeature = (city) => {
  fetch(
    ...
    .then((json) => {
      ...
      const localTimeValue = currentLocalTime.toLocaleTimeString(["en-GB"], {
        timeStyle: "short",
        timeZone: "UTC",
      });

      // Update the HTML to display the current time
      localTime.innerHTML = `Time: ${localTimeValue}`;

      // Get sunrise and sunset times adjusted for the city's time zone
      ...
      const sunsetShort = sunsetTime.toLocaleTimeString(["en-GB"], {
        timeStyle: "short",
      });

      // Update HTML with sunrise and sunset information
      ...
      // Get the current local time with the city's timezone
      ...
      if (currentTime >= sunriseTimeHour && currentTime <= sunsetTimeHour) {
        ...
        if (todaysWeather === "Clear") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1613931189161-1f4d2660bd1e?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDczNDI&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Clouds") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1424111113808-b7be56a9f3d6?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2NzcyNTczNTA&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Rain") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1424111113808-b7be56a9f3d6?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2NzcyNTczNTA&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Snow") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1610486549369-585a0e6d8cc4?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDc4NDE&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Thunderstorm") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1602088501827-7912e1b4a7bd?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDc5ODI&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Drizzle") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1554039362-6daf559ddb63?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDgyNDk&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Atmosphere" || todaysWeather === "Haze") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1543226549-10d29b2cfaf0?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDg0MTI&ixlib=rb-4.0.3&q=80')";
        } else {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1424111113808-b7be56a9f3d6?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2NzcyNTczNTA&ixlib=rb-4.0.3&q=80')";
        }
        ...
        if (todaysWeather === "Clear") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1620055374842-145f66ec4652?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDkxMTY&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Snow") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1602857731804-80e82120ff27?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDkzNzQ&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Rain") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1505144992585-d281c0e2cff8?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDk1OTA&ixlib=rb-4.0.3&q=80')";
        } else if (todaysWeather === "Clouds") {
          featureImage.style.backgroundImage =
            "url('https://images.unsplash.com/photo-1518352724948-729151797553?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MDk1OTA&ixlib=rb-4.0.3&q=80')";
        } else {
          featureImage.style.backgroundImage =
            "url(' https://images.unsplash.com/photo-1604083142449-79b1babd12d4?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc0MTIwOTM&ixlib=rb-4.0.3&q=80')";
        }
      }
...
const weatherForecastData = (city) => {
  fetch(
    ...
    .then((result) => {
      if (result.cod !== "404") {
        //If the user did NOT search for a city that does not exist

        const todaysDate = new Date().toString().split(" ")[0]; //Today's date in text form
        const filterData = result.list.filter((weatherDay) =>
          weatherDay.dt_txt.includes("12:00")
        ); //Filters out the data at 12:00 every day
        ...
        //If the user DID search for a city that does not exist. Alerts user that the city cant be found. Then runs Stockholm again.
...
const getNextCity = () => {
  ...
  if (city === "Stockholm") {
    ...
    todaysWeatherFeature("Barcelona");
    weatherForecastData("Barcelona");
    city = "Barcelona";
  } else {
    todaysWeatherFeature("Stockholm");
    weatherForecastData("Stockholm");
